...
public class FangdongshensuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FangdongshensuEntity() {
		
	}
	
	public FangdongshensuEntity(T t) {
		try {
	 ...
	 * 设置：房东申诉
	 */
	public void setFangdongshensu(String fangdongshensu) {
		this.fangdongshensu = fangdongshensu;
	}
	/**
	 * 获取：房东申诉
	 */
	public String getFangdongshensu() {
		return fangdongshensu;
	}
	/**
	 * 设置：回复内容
	 */
